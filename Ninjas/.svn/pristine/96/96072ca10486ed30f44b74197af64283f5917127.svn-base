...
public class Webcam {
	...
	/**
	 * Renvoie vrai si la webcam lit une image et la stocke.
	 * @return
	 */
	public boolean read() {
	...
	/**
	 * Ajoute l'image correspondant a l'element s sur l'image de la webcam
	 */
	...
	/**
	 * Dessine un rectangle transparent sur l'ecran.
	 **/
	public void rectangleDetection(Rectangle r) {
		rectangle(image, new Rect(r.x, r.y, r.width, r.height), Scalar.RED, 3, CV_AA, 0);
	}
	
	/**
	 * Remplace les pixels de la couleur stockee dans webcam par du rouge
	 */
	...
	/**
	 * Detecte la couleur du rectangle passe en argument, et met a jour les entiers r,g,b de la classe Webcam
	 **/
	...
	/**
	 * Renvoie un tableau contenant les composants r,g,b, dans cet ordre, du pixel aux coordonees x,y.
	 * @param row La coordonnee en y du pixel 
	 * @param col La coordonnee en x du pixel
	 */
